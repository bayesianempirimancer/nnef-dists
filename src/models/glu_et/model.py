...
class Config(BaseConfig):
    ...
    Contains all parameters needed for GLU ET model architecture.
    """
    
    # === MODEL IDENTIFICATION ===
    model_name: str = "glu_et_net"
    
    # === GLU-SPECIFIC PARAMETERS ===
    gate_activation: str = "sigmoid"  # Activation for the gate in GLU
...
class GLU_ET_Net(BaseModel[Config]):
    """
