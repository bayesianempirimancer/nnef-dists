...
if __name__ == "__main__":
    ...
    from src.models.noprop_geometric_flow_et.model import Config, NoProp_Geometric_Flow_ET_Network
else:
    # When used as module, use relative imports
    from .model import Config, NoProp_Geometric_Flow_ET_Network
