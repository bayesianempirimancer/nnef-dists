...
def make_predictions(model, params, eta_data: np.ndarray, batch_size: int = 100) -> np.ndarray:
    """
    ...
    Args:
        ...
        eta_data: Input data (eta values)
...
def create_learning_plot(
    ...
    """
    Create a comprehensive learning plot with training analysis.
    ...
    fig.suptitle(f'{model_name} - Training Analysis', fontsize=16, y=0.95)
    ...
    arch_text += f"Embedding: {config.get('embedding_type', 'default')}\n"
