#!/usr/bin/env python
"""Training script for the large 1D Gaussian model."""
...
from plot_1d_results import plot_gaussian_1d_results

def train_large_1d_gaussian():
    """Train the large 1D Gaussian model with the configuration from gaussian_1d_large.yaml."""
    
    # Load the large configuration
    config_file = "configs/gaussian_1d_large.yaml"
    ...
    history_file = f"artifacts/large_1d_training_history_{config_hash}.pkl"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Train large 1D Gaussian model")
    parser.add_argument("--config", default="configs/gaussian_1d_large.yaml",
    ...
    if args.plot_only:
        ...
        if not args.data_file or not args.history_file:
            ...
            if not args.history_file:
                args.history_file = f"artifacts/large_1d_training_history_{config_hash}.pkl"
